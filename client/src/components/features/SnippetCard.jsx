...
const SnippetCard = ({ snippet, onLike, onStar, onFork, showFullCode = false }) => {
  ...
  const previewCode = showFullCode ? snippet.code : snippet.code.slice(0, 300) + (snippet.code.length > 300 ? '...' : '');
  ...
  return (
    ...
    >
      ...
      <div className="relative mb-4 rounded-lg overflow-hidden bg-dark-900 border border-dark-700">
        ...
        {!showFullCode && snippet.code.length > 300 && (
